...
module.exports = {
  ...
  TULINGKEY: '', //图灵机器人KEY
  TXAPIKEY: '2198ce330d1e7d3a79877b24940afd8c',// 必填，天行数据key，目前贡献的是我个人的，建议申请自己的天行数据key，可以对机器人个性化定制
  /**
   * 每日说定时任务（支持多人）
   ...
   */
  DAYLIST: [
    {name:'军建',alias:'军建',memorialDay:'2019/09/03',city:'上海',endWord:'一个忠实的 robot',date:'0 0 8 * * *'},
    {name:'军建',alias:'军建',memorialDay:'2019/09/03',city:'上海',endWord:'一个忠实的 robot',date:'0 0 18 * * *'},
  ],
  ...
  CUSTOMROOMLIST: [
    {roomName:'上海三栖开发',message:'请大家举起水杯，干杯',endWord:'来自一个无聊的 robot',date:'0 30 9-20 * * 1-5'},
  ],
   /**
